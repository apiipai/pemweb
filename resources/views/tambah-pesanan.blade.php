...
@section('content')
    ...
    <section id="menu" class="text-center mt-5">
        ...
        <form id="orderForm" action="{{ route('kelola-pesanan.store') }}" method="POST">
            @csrf
            <p style="font-size: pt">Tambah Order</p>
            ...
            <button type="submit" id="checkout" style="margin-bottom: 100px;">Tambah</button>
        </form> 
    </section>    
